...
?>
    ...
    <div class="card text-white bg-dark position-absolute top-50 start-50 translate-middle p-3"
        ...
        <form method="POST" onsubmit="return validarFormulario()">
            ...
            <textarea id="formacao" name="formacao" rows="5" cols="40"></textarea>

            <label for="objetivo">Objetivo:</label>
            <textarea id="objetivo" name="objetivo" rows="5" cols="40"></textarea>

            <label for="cursos_complementares">Cursos Complementares:</label>
            <textarea name="cursosComplementares" rows="5" cols="40"></textarea>
